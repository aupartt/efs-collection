...
import collector.services.groups as group_services
...
async def test_load_groups(mocker, async_cm, mock_grp):
    ...
    mocker.patch("collector.services.groups.get_db", return_value=async_cm(mock_session))
    mocker.patch(
...
async def test_save_groups(mocker, async_cm, mock_grp):
    mocker.patch("collector.services.groups.add_group", return_value=async_cm("added"))
