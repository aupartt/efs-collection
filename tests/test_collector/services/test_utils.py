...
import collector.services.utils as utils_services
...
async def test_check_api_success(mocker):
    ...
    mock_api_ping = mocker.patch(
        "collector.services.utils.api_ping.asyncio", return_value=mock_ping
    )
...
async def test_check_api_exception(mocker):
    mock_api_ping = mocker.patch(
        "collector.services.utils.api_ping.asyncio",
