...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_locations_group_code"), "locations", ["group_code"], unique=False
    )
    op.create_index(
        op.f("ix_locations_post_code"), "locations", ["post_code"], unique=False
    )
    op.create_index(
        op.f("ix_locations_sampling_location_code"),
        "locations",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["sampling_location_code"],
            ["locations.sampling_location_code"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(op.f("ix_collections_date"), "collections", ["date"], unique=False)
    op.create_index(
        "ix_collections_date_group", "collections", ["date", "group_code"], unique=False
    )
    op.create_index(
        "ix_collections_date_location",
        "collections",
        ["date", "sampling_location_code"],
        unique=False,
    )
    op.create_index(
        op.f("ix_collections_group_code"), "collections", ["group_code"], unique=False
    )
    op.create_table(
        "schedule_snapshots",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_schedule_snapshots_crawled_at"),
        "schedule_snapshots",
        ["crawled_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_schedule_snapshots_url"), "schedule_snapshots", ["url"], unique=False
    )
    op.create_index(
        "ix_schedule_snapshots_url_time",
        "schedule_snapshots",
        ["url", "crawled_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_schedule_events_date"), "schedule_events", ["date"], unique=False
    )
    op.create_index(
        "ix_schedule_events_date_type",
        "schedule_events",
        ["date", "event_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_schedule_events_snapshot_id"),
        "schedule_events",
        ["snapshot_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_schedule_snapshots_crawled_at"), table_name="schedule_snapshots"
    )
