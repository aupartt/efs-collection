...
Revision ID: 351262a5207c
Revises:
Create Date: 2025-08-10 10:16:53.489388
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_collection_groups_efs_id"),
        "collection_groups",
        ["efs_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_collection_group_snapshots_created_at"),
        "collection_group_snapshots",
        ["created_at"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_collection_group_snapshots_created_at"),
        table_name="collection_group_snapshots",
    )
