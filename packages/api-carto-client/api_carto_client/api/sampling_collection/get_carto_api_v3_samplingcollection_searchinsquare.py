...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/carto-api/v3/samplingcollection/searchinsquare",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Retourne une liste de collectes dans un carré à partir des coordonnées du point Nord-Est et du point
    Sud-Ouest.
