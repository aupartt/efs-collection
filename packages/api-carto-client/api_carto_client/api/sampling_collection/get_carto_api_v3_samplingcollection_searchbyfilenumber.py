...
def _get_kwargs(
    *,
    file_number: int,
    show_weekly_schedule: Union[Unset, bool] = UNSET,
    ...
    params["ShowWeeklySchedule"] = show_weekly_schedule
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/carto-api/v3/samplingcollection/searchbyfilenumber",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Retourne une liste de collectes par numéro de fiche de leur lieu de prélèvement.

    Args:
        file_number (int):
        show_weekly_schedule (Union[Unset, bool]):
    ...
    kwargs = _get_kwargs(
        ...
        show_weekly_schedule=show_weekly_schedule,
