...
def _get_kwargs(
    *,
    city_name: str,
    city_name_without_diacritics: Union[Unset, str] = UNSET,
    ...
    params["CityNameWithoutDiacritics"] = city_name_without_diacritics
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/carto-api/v3/samplinglocation/searchbycityname",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Retourne une liste de lieux de prélévement situés dans une ville.

    Args:
        city_name (str):
        city_name_without_diacritics (Union[Unset, str]):
    ...
    kwargs = _get_kwargs(
        city_name=city_name,
        city_name_without_diacritics=city_name_without_diacritics,
