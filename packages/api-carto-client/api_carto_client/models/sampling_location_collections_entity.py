...
if TYPE_CHECKING:
    from ..models.sampling_collection_entity import SamplingCollectionEntity


T = TypeVar("T", bound="SamplingLocationCollectionsEntity")


@_attrs_define
class SamplingLocationCollectionsEntity:
    """Objet de retour lieux + collectes

    Attributes:
        collections (Union[None, Unset, list['SamplingCollectionEntity']]): Collectes associées
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_collections(data: object) -> None | Unset | list["SamplingCollectionEntity"]:
            ...
            try:
                ...
                for collections_type_0_item_data in _collections_type_0:
                    collections_type_0_item = SamplingCollectionEntity.from_dict(collections_type_0_item_data)
        ...
        sampling_location_collections_entity = cls(
        ...
        return sampling_location_collections_entity
