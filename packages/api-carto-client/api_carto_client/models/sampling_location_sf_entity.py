...
T = TypeVar("T", bound="SamplingLocationSFEntity")


@_attrs_define
class SamplingLocationSFEntity:
    """Entité de base pour les lieux de prélèvements fixes.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sampling_location_sf_entity = cls(
        ...
        return sampling_location_sf_entity
